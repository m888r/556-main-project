function [rrf, pf_des_w, hips] = locoController(X, pf, dpf, t, q, dq)
...
if isequal(gaitname, "standing")
    ...
    [rrf_swing, pf_des_w, hips] = swing_control(X, walking_Xd(4:6), 0.5, pf, dpf, t, gaitperiod, currcontact, ftcontacts);
